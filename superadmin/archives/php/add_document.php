<?php
    ...
    if($fileName){
        ...
        $fileDestination = '../../../organization/admin/archives/document_upload/'.$fileNameNew;
    ...
    $addDocumentSql = "INSERT INTO document (document_name,description,file,is_active,created_by) VALUES ('$document_name','$document_description','$file',1,'$user_id')";
