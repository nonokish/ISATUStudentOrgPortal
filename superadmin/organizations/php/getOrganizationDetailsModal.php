...
<?php
    ...
    if($row['org_image']){
        $src = 'add_organization/organization_uploads/'.$org_image.'';
    } else {
	...
	echo '
        ...
        <div class="row">
            ...
            <img
                ...
                id="org_display_img"
              />
              <input type="file" class="form-control mx-auto" id="orgImage_id_for_update" name="orgImage_for_update" style="width: 400px;" value="'.$org_image.'"/>
            </div>
