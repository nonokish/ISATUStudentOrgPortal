...
<?php
    ...
    $orgDocumentSql = "SELECT d.id as doc_id, d.document_name as org_document_name, d.description as org_description, d.file as file, d.date_created as doc_date_uploaded FROM document d WHERE d.organization_id = '$org_id' AND d.is_active = 1";
        ...
        while($row = mysqli_fetch_assoc($orgDocumentResult)){
            ...
            echo '
                <tr>
                    ...
                    <td>
                    <a class="see-contents-link py-1 px-3" href="./document_upload/'.$file.'" download>Download</a>
