...
<?php  
    ...
    $orgDetailsSql = "SELECT onf.id as onf_id, n.caption as newsfeed_caption, n.publish_date as newsfeed_pub_date, o.id as org_id, o.name as org_name FROM organization o INNER JOIN organization_newsfeed onf ON o.id = onf.organization_id INNER JOIN newsfeed n ON onf.newsfeed_id = n.id WHERE o.id = '$org_id'";
