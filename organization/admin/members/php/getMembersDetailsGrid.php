...
<?php  
    ...
    $memberDetailsSql = "SELECT uo.date_joined as date_joined, CONCAT(u.first_name, ' ', u.middle_initial, ' ', u.last_name) as member_name, u.course_year as course_year, o.name as org_name, u.email as member_email, u.contact as member_contact FROM user u INNER JOIN user_organization uo ON u.id = uo.user_id INNER JOIN organization o ON uo.organization_id = o.id WHERE uo.organization_id = '$org_id'";
