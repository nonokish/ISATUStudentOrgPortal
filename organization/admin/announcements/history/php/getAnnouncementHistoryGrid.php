...
<?php  
    ...
    $orgDetailsSql = "SELECT oa.id as oa_id, a.title as ann_title, a.publish_date as ann_pub_date, o.id as org_id, o.name as org_name FROM organization o INNER JOIN organization_announcement oa ON o.id = oa.organization_id INNER JOIN announcement a ON oa.announcement_id = a.id WHERE o.id = '$org_id' AND oa.is_active = 1";
