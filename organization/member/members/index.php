        ...
        <div class="modal-body px-5 py-4" id="getMemberModalDetails">
          <!--<div class="row">
            ...
            <div class="col-md-6 px-2">
              ...
              <input type="text" id="" class="form-control mb-4" value="Department Name" disabled>
            </div>
            <div class="col-md-6 px-2">
              <label class="float-left mb-1 field-label">Course & Year</label>
              <input type="text" id="" class="form-control mb-4" value="Course & Year" disabled>
            </div>
            <div class="col-md-6 px-2">
              <label class="float-left mb-1 field-label">Email</label>
              <input type="text" id="" class="form-control mb-4" value="member@gmail.com" disabled>
            </div>
            <div class="col-md-6 px-2">
            ...
            <div class="col-md-6 px-2">
              ...
              <input type="text" id="" class="form-control mb-4" value="Designation Name" disabled>
            </div>
            <div class="col-md-6 px-2">
