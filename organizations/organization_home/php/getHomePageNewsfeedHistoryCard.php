...
<?php
    ...
    $newsfeedSql = "SELECT n.id as n_id, n.display_image as display_image, n.publish_date as publish_date, n.publish_time as publish_time, o.name as org_name, n.caption as n_caption FROM newsfeed n INNER JOIN organization_newsfeed onf ON n.id = onf.newsfeed_id INNER JOIN organization o ON onf.organization_id = o.id WHERE o.id = '$organization_id' AND $where_clause_input_filter AND $where_clause ORDER BY n.publish_date DESC,n.publish_time DESC";
    ...
    if(mysqli_num_rows($newsfeedResult) > 0){
        while($row = mysqli_fetch_assoc($newsfeedResult)){
            ...
            echo '
                <div class="col-md-12" id="newsfeedHistoryCardDetail">
