...
?>
<?php
    $newsfeedSql = "SELECT n.id as n_id, n.display_image as display_image, n.publish_date as publish_date, o.name as org_name, n.caption as n_caption FROM newsfeed n INNER JOIN organization_newsfeed onf ON n.id = onf.newsfeed_id INNER JOIN organization o ON onf.organization_id = o.id";
